...
#
# Feedback: Please send feedback to brian.carpenter@wosc.edu
#                                   
#
# ==========================================================
# ==========================================================
...
def getHostInfo():
    host = {}
    hostfd = open("/proc/sys/kernel/hostname")
    host['name'] = hostfd.next().strip()
    hostfd.close()
    domainfd = open("/proc/sys/kernel/domainname")
...
def getDistGentooInstPkgs():
    ...
    package.sort()
    instPackages = []
    emergeLog = open("/var/log/emerge.log")
    installTimes = {}
    for i in emergeLog:
